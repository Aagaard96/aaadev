...
const projects = [
    {
        title: "WILLUM. - Current Project",
        description: "The company is a consultancy specializing in project, financial, and contract management within the construction industry. They offer flexible solutions and take responsibility from start to finish.",
        occupation: "Project Management & Construction Consultancy",
        img: "/willum.png",
        link: "https://wplay.netlify.app"
    },
    {
        title: "PAATUR",
    ...
    return (
        <section id="projects" className="pt-32 overflow-hidden">
            ...
            <div ref={projectRef} className="max-w-5xl mx-auto relative border-2 border-accentGreen bg-inherit px-5 lg:px-0 rounded-sm flex flex-col items-center py-5">
                ...
                <ShadowAnimation
                    className="absolute right-0 top-3/4 translate-x-1/2 transform"
                    color="#dc2626FF"
                    blur="500px"
                    spread="200px"
                    scrollTargetRef={projectRef}
